...
app.put('/api/admin/reservations/:id', authenticateToken, (req: any, res) => {
  try {
...
app.put('/api/admin/menu-items/:id', authenticateToken, (req: any, res) => {
  try {
    const { category_id, name, description, price, image_url, dietary_tags, is_featured } = req.body;
    const stmt = db.prepare(`
...
app.delete('/api/admin/menu-items/:id', authenticateToken, (req: any, res) => {
  try {
...
app.put('/api/admin/posts/:id', authenticateToken, (req: any, res) => {
  try {
    const { title, content, image_url, type, date } = req.body;
...
app.delete('/api/admin/posts/:id', authenticateToken, (req: any, res) => {
  try {
